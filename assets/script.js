window.onload=function ()
{
	...
	for(var i=1;i<=M;i++)
	{
		...
		oNewDiv.style.background='url(img/'+i+'.png)';

		oNewDiv.getElementsByClassName('over')[0].style.background='-webkit-linear-gradient(rgba(0,0,0,1) 40%, rgba(255,255,255,0)), url(img/'+i+'.png)';
